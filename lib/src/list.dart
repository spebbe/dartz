...
class ListTraversableMonadPlus extends Traversable<List> with Applicative<List>, Monad<List>, MonadPlus<List>, TraversableMonad<List> {
...
MonadPlus<List/*<A>*/> listMP/*<A>*/() => ListMP as dynamic/*=MonadPlus<List<A>>*/;
